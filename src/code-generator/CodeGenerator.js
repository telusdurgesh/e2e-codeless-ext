...
const wrapDescribeHeader = (opt) => `describe('${opt.testTitle}', function() {\n`;

const wrapDescribeFooter = `})`;

const wrapItHeader = (opt) => ` it('${opt.titleDesc}', function() {\n`;
...
export const defaults = {
  ...
  dataAttribute: '',
  testTitle: 'test_name_default',
  titleDesc: 'what_it_does',
  serverUrl: '',
};
...
export default class CodeGenerator {
  ...
  _getHeader() {
    ...
    let describeHeader = this._options.wrapDescribe ? wrapDescribeHeader(this._options) + newLine : '';
    return describeHeader + wrapItHeader(this._options) + newLine;
  }
